...
update master
set returned = @newcode, qlevel='999'
...
Are you sure this is OK?"
		...
		If DataChangeWarning.ShowDialog = DialogResult.OK Then
			msg = "Wait!  Are you really sure you want to change the Returned dates of these " + Me.ACount.Text + " accounts. 
Is this really OK?"
			...
			For Each row As DataGridViewRow In DataGridView1.Rows
				...
				If FindAccounts(row.Cells(fcol).Value) Then
					...
					If vt.Rows.Count > 0 Then
						cm1.Parameters("@number").Value = row.Cells(fcol).Value.ToString
